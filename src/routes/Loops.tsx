    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--ink)' }}>
      ...
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: '140px 32px 60px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 40 }}>
          <div style={{ font: 'var(--text-caption-2)', letterSpacing: 1.6, textTransform: 'uppercase', color: 'var(--cool)' }}>
            § · Loops · Process
          </div>
        ...
        <h1 style={{
          ...
          The patterns I <span style={{ color: 'var(--cool)' }}>run on myself</span>.
        </h1>
      ...
      <section style={{ maxWidth: 1040, margin: '0 auto', padding: '40px 32px 80px' }}>
        <div style={{ font: 'var(--text-caption-2)', letterSpacing: 1.4, textTransform: 'uppercase', color: 'var(--ink-3)', marginBottom: 18 }}>
        ...
        <div style={{ position: 'relative', height: 280, border: '1px solid var(--line)', borderRadius: 8, background: 'var(--surface)', padding: '40px 60px' }}>
          ...
          <div style={{ position: 'absolute', left: 60, top: '50%', marginTop: 14, font: 'var(--text-caption-2)', letterSpacing: 0.8, textTransform: 'uppercase', color: 'var(--ink-3)' }}>
            ← makes me uncomfortable
          </div>
          <div style={{ position: 'absolute', right: 60, top: '50%', marginTop: 14, font: 'var(--text-caption-2)', letterSpacing: 0.8, textTransform: 'uppercase', color: 'var(--ink-3)' }}>
            comes naturally →
          </div>
              ...
              <div key={d.label} style={{ position: 'absolute', left: `${d.x}%`, top: '50%' }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    position: 'absolute',
                    left: '50%',
                    top: offsetY < 0 ? '100%' : -10,
                    width: 1,
                    height: Math.abs(offsetY) - 6,
                    background: 'var(--line)',
                  }} />
                </div>
              </div>
        ...
        <p style={{ font: 'var(--text-caption-2)', color: 'var(--ink-3)', letterSpacing: 0.3, marginTop: 14, maxWidth: 680 }}>
